with(obj_bullet_enemy) {
	...
	if sprite_index == spr_bullet_large and image_index == 14 {
		instance_destroy();
		for(var i = 0; i < 4 + (global.difficulty * 2); i += 1) {
			scr_shoot_bullet_enemy(1,(360 / (4 + (global.difficulty * 2))) * i,spr_bullet_arrow,9,0,0,true,snd_enemy_fire_kira);
		}
	}
}
randomize();
