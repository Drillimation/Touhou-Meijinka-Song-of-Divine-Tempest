...
for(var i = 0; i < (global.difficulty * 4) + 10; i += 1) {
	scr_shoot_bullet_enemy(1.5,(360 / ((global.difficulty * 4) + 10)) * i,spr_bullet_dagger,0,0,0,false,snd_enemy_fire);
	scr_shoot_bullet_enemy(1.25,(360 / ((global.difficulty * 4) + 10)) * i,spr_bullet_dagger,8,0,0,false,snd_enemy_fire);
}