...
draw_sprite(spr_enemy_spell_banner,0,view_xview + x_pos,view_yview + 24);

draw_set_font(font_misaki);
draw_set_color(make_color_rgb(0,0,0));
draw_text((view_xview + x_pos) + 1,(view_yview + 32) + 1,txt);
draw_set_color(make_color_rgb(255,255,255));
draw_text(view_xview + x_pos,view_yview + 32,txt);
draw_set_alpha(1);

if instance_exists(boss_id) {
	draw_set_color(make_color_rgb(0,0,0));
	draw_text((view_xview + x_pos) + 1,(view_yview + 24) + 1,string(percen) + "%");
	draw_set_color(make_color_rgb(255,255,255));
