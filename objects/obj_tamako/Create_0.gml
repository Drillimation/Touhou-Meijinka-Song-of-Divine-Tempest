can_attack = false;
entered = false;
scr_boss_stats(2,750);
enemy_id = 0;
_t = 0;
defeat_img = spr_tamako_defeat;
_bar = spr_boss_health_2

if global.difficulty >= 2 { attack[0] = timeline_spell_card_02; } else { attack[0] = timeline_spell_card_01; } start_time[0] = 30;
attack[1] = timeline_tamako; start_time[1] = 25;
...
if struct_exists(_load_data, "boss_names") {
	...
	txt = string(struct_get(_load_data.boss_names,"a0"));
}
