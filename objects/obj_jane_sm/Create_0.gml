...
enemy_id = 0;
_t = 0;
defeat_img = spr_jane_sm_defeat;
_bar = spr_boss_health_2

if global.difficulty >= 2 { attack[0] = timeline_spell_card_26; } else { attack[0] = timeline_spell_card_25; } start_time[0] = 50;
attack[1] = timeline_jane_sm; start_time[1] = 45;
